...
export class DataService {
  ...
  getB2BInvoice():Observable<any>{
    ///return this.http.get('http://192.168.2.167:8080/gst/rest/gstr1/findb2b/'+this.GstInnum+'/'+this.Returnperiod);
    return this.http.get('http://192.168.2.167:8080/gst/rest/gstr1/findb2b/nagaraju1234/august');
  }
  getb2cl(){
    //return this.http.get('http://192.168.2.167:8080/gst/rest/gstr1/findb2cl/'+this.GstInnum+'/'+this.Returnperiod);
    return this.http.get(' http://192.168.2.167:8080/gst/rest/gstr1/findb2cl/nagaraju1234/august');
  }
  getb2cla(){
    //return this.http.get('http://192.168.2.167:8080/gst/rest/gstr1/findb2cla/'+this.GstInnum+'/'+this.Returnperiod);
    return this.http.get(' http://192.168.2.167:8080/gst/rest/gstr1/findb2cla/nagaraju1234/august');
  }
  getb2cs(){
    //return this.http.get('http://192.168.2.167:8080/gst/rest/gstr1/findb2cs/'+this.GstInnum+'/'+this.Returnperiod);
    return this.http.get('http://192.168.2.167:8080/gst/rest/gstr1/findb2cs/nagaraju1234/august');
  }
  getb2csa(){
    return this.http.get('http://192.168.2.167:8080/gst/rest/gstr1/findb2csa/nagaraju1234/august');
  }
getcdnr(){
  return this.http.get('http://192.168.2.167:8080/gst/rest/gstr1/findcdnr/nagaraju1234/august');
}
getExp(){
  return this.http.get(' http://192.168.2.167:8080/gst/rest/gstr1/findexp/nagaraju1234/august');
}
getExpa(){
  return this.http.get(' http://192.168.2.167:8080/gst/rest/gstr1/findexpa/nagaraju1234/august'); 
}
getcdnura(){
  return this.http.get('http://192.168.2.167:8080/gst/rest/gstr1/findcdnura/nagaraju1234/august'); 
}
gettxpda(){
  return this.http.get(' http://192.168.2.167:8080/gst/rest/gstr1/findtxpda/nagaraju1234/august');  
}
getdocissue(){
  return this.http.get(' http://192.168.2.167:8080/gst/rest/gstr1/finddoc/nagaraju1234/august'); 
}
getcdnur(){
  return this.http.get(' http://192.168.2.167:8080/gst/rest/gstr1/findcdnur/nagaraju1234/august'); 
}
getb2ba()

{
return this.http.get('http://192.168.2.167:8080/gst/rest/gstr1/findb2ba/nagaraju1234/august');

}

getnil():Observable<any>{

return this.http.get('http://192.168.2.167:8080/gst/rest/gstr1/findnil/nagaraju1234/august');

}

 getcdnra():Observable<any>{
...
return this.http.get('http://192.168.2.167:8080/gst/rest/gstr1/findhsn/nagaraju1234/august');

}

getTxp(){
  return this.http.get('http://192.168.2.167:8080/gst/rest/gstr1/findtxp/nagaraju1234/august');
}
